                  ...
                  <div class="flex-1">
                    <div class="flex align-items-center mb-3">
                      ...
                      <div class="flex-1">
                        ...
                        <div v-if="demande.message_demande" class="p-3 bg-surface-50 border-round mb-3">
...
const getStatusBgClass = (statut: string): string => {
  switch (statut) {
    case 'ACCEPTEE':
      return 'bg-green-50 border-green-200 border-1'
    case 'REFUSEE':
      return 'bg-red-50 border-red-200 border-1'
    default:
      return 'bg-surface-50 border-surface-200 border-1'
  }
}
